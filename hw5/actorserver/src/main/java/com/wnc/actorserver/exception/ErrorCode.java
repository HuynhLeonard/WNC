package com.wnc.actorserver.exception;
...
public enum ErrorCode {
    //User Error
    USERNAME_INVALID(3001, "Username is invalid", HttpStatus.BAD_REQUEST),
    INVALID_PASSWORD(3002, "Password is invalid", HttpStatus.BAD_REQUEST),
    UNAUTHENTICATED(3003,"Unauthenticated", HttpStatus.UNAUTHORIZED),
    USER_NOT_EXISTED(3004,"User not existed", HttpStatus.NOT_FOUND),
